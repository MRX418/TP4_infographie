...
///////////////////////////////////////////////////////////////////////////
/// @class ProgNuanceur
/// @brief Classe pour charger les nuanceurs
///
///        Fonctions utilitaires pour gérer les nuanceurs GLSL
///
...
public:
    ...
    static const GLchar *chainesSommetsBase;
    // le nuanceur de fragments minimal
    static const GLchar *chainesFragmentsBase;
...
// le nuanceur de sommets minimal
const GLchar *ProgNuanceur::chainesSommetsBase =
{
    "#version 410\n"
...
// le nuanceur de fragments minimal
const GLchar *ProgNuanceur::chainesFragmentsBase =
{
    "#version 410\n"
    "in vec4 couleur;\n"
    "out vec4 FragColor;\n"
