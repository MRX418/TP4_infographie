...
///////////////////////////////////////////////////////////////////////////
/// @class Bitmap
/// @brief Classe pour charger une texture
///
///        Fonctions utilitaires pour charger une texture
///
...
unsigned char *ChargerImage( std::string fichier, GLsizei &largeur, GLsizei &hauteur )
{
    ...
    //     // {
    //     //     printf( "SDL_image n'a pas été initialisé correctement! SDL_image Error: %s\n", IMG_GetError() );
    //     // }
    //     //SDL_Window *win = SDL_CreateWindow("Hello World", 0, 0, largeur, hauteur, 0);
    //     SDL_Window *win;
    //     SDL_Renderer *renderer = SDL_CreateRenderer( win, -1, SDL_RENDERER_ACCELERATED );

    //     SDL_Surface *surface = IMG_Load( fichier.c_str() );
    //     if ( surface == NULL )
    //         printf("IMG_Load: %s\n", IMG_GetError());
    ...
    //     hauteur = surface->h;
    //     unsigned int taille = largeur * hauteur * 4; // l * h * 4 composantes
    //     std::cerr << "//@inf2705-texture," << __LINE__ << ";" << " largeur=" << largeur << " hauteur=" << hauteur << " taille=" << taille << std::endl;
    //     pixels = new unsigned char[taille];
    //     SDL_LockSurface(surface);
    //     memcpy( pixels, surface->pixels, taille*sizeof(unsigned char) );
